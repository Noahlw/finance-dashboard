...
- **ID formats** (generated by `Ids.nextId(entity)` from the `Counters` tab, under lock): `U-0001`, `CAT-ACT`, `EV-<SEM>-001`, `BR-<SEM>-001`, `BRL-<SEM>-001-01`, `EC-<SEM>-001`, `CLI-<SEM>-001-01`, `RC-0001`, `IN-<SEM>-001`, `PO-<SEM>-001`, where `<SEM>` = `Config.get('CURRENT_SEMESTER')` (e.g. `26A`).
...
| `TREASURER_USER_ID` | `U-0001` | Engine (D4 role checks) |
...
- **P3:** an approval performed in AppSheet by an exco personal account lands in AuditLog attributed to **that person's** U-id (via `intent_actor_email`), not the shared account; nightly snapshot appears in the backup account; integrity sweep reports clean.
