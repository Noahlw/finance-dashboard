...
- [#60](https://github.com/Noahlw/finance-dashboard/issues/60), [#61](https://github.com/Noahlw/finance-dashboard/issues/61), [#62](https://github.com/Noahlw/finance-dashboard/issues/62), [#63](https://github.com/Noahlw/finance-dashboard/issues/63), [#65](https://github.com/Noahlw/finance-dashboard/issues/65) — already-created `ready-for-agent` tickets.
- Not yet ticketed: the full 9-endpoint auth-gap inventory as individual acceptance criteria, and the free-text `eventId` migration/backfill decision once the real `event_id` foreign key exists.
