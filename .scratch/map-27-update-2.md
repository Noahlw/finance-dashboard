...
- [Grilling: What closes the React web app wayfinder map?](https://github.com/Noahlw/finance-dashboard/issues/56) — see [ADR 0175](https://github.com/Noahlw/finance-dashboard/blob/main/docs/adr/0175-wayfinder-map-closes-on-decisions-not-fixes.md). The map closes on decisions locked + clean tracker, not on fixes merged/verified. Falsifiable closure checklist: (1) every wayfinder:* child of #27 resolved — #57, #58, #59, and anything they spawn; (2) #57 confirms every one of #29-#32 and #33-#54 is closed-with-resolution, kept-open-with-real-decision, or replaced; (3) #59 records a named owner + trigger for the staging evidence checklist — locked: Treasurer, triggered once all #55/#59 blockers merge, run before production clasp push/deploy; (4) a go-live decision is recorded — who approves cutover and against which staging deployment ID; (5) no stray item remains in "Not yet specified" outside the scope of 1-4.

## Not yet specified

- #57's reconciliation of #29-#32 and #33-#54 (expanded scope per #56) is not yet done.
...
- #59's remaining decision items: P0-A/P0-B blocker classification, and Event picker pre-launch vs. post-launch. (Item 3, staging checklist ownership, is now locked — see #56/ADR 0175.)
