...
> **This document is superseded.** AppSheet has been abandoned in favor of the code-managed React/Vite web app served by Apps Script HTML Service. See [Committee Finance Web App Specification](../../spec.md) for the current architecture. This document is retained for historical reference only.
