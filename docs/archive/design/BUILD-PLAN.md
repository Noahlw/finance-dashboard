...
> **This document is superseded.** AppSheet and the Tier-2 build plan have been abandoned. See [Committee Finance Web App Specification](../../spec.md) for the current architecture. This document is retained for historical reference only.
